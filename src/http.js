...
export const withTimeout=(ms,fn)=>{const c=new AbortController();const timer=setTimeout(()=>c.abort(),ms);return Promise.resolve().then(()=>fn(c.signal)).finally(()=>clearTimeout(timer))};
